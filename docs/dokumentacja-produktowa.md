...
- Jeśli natomiast uda się pobrać użytkownika, ale zawiedzie pobranie listy zadań, widok nadal pokazuje profil użytkownika (avatar, dane, statystyki na tym etapie niedostępne) razem z osobnym, czytelnym komunikatem o błędzie pobierania zadań i przyciskiem „Retry” ograniczonym tylko do ponowienia tego zapytania.
...
- W trakcie wykonywania żądania przycisk potwierdzenia pokazuje stan „Deleting…” i jest zablokowany, tak aby kolejne kliknięcie nie wysłało drugiego żądania.
