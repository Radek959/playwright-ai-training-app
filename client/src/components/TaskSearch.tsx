...
export function TaskSearch({ onSelect, placeholder = "Szukaj zadań..." }: Props) {
  ...
  return (
    <div className="relative w-full" data-testid={getTestId("task-search-container")}>
      <div className="relative">
        <input
          ...
          data-testid={getTestId("task-search-input")}
          className="w-full border rounded-lg px-4 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />

        {/* Loading Spinner */}
        {loading && (
          <div className="absolute right-3 top-1/2 -translate-y-1/2" data-testid={getTestId("search-spinner")}>
        ...
        {!loading && query.length > 0 && (
          <button
            ...
            data-testid={getTestId("search-clear-btn")}
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {showDropdown && (
        <div
          ...
          data-testid={getTestId("search-results-dropdown")}
        >
          {results.length > 0 ? (
            <>
              ...
              {results.map((task, index) => (
                <button
                  ...
                  data-testid={getTestId(`search-result-${task.id}`)}
            ...
            <div className="px-4 py-6 text-center text-gray-500 text-sm" data-testid={getTestId("search-no-results")}>
