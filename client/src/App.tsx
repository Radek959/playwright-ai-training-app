...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-gray-50 to-gray-100">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[100] focus:bg-white focus:text-indigo-700 focus:px-4 focus:py-2 focus:rounded-lg focus:shadow-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-indigo-600"
      >
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <header className="md:hidden bg-white shadow-sm border-b border-gray-200 sticky top-0 z-30">
          <div className="flex items-center justify-between p-4">
            <button
              ...
              className="p-2 hover:bg-gray-100 rounded-lg transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-indigo-600"
        ...
        {/* Error Banner */}
        {error && (
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-b border-amber-200 shadow-sm" role="alert">
            <div className="px-4 md:px-6 py-3 flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-amber-900 flex-1">{error}</span>
              <button
                type="button"
                onClick={clearError}
                aria-label="Dismiss error"
                className="text-amber-700 hover:text-amber-900 flex-shrink-0 p-1 rounded focus-visible:outline focus-visible:outline-2 focus-visible:outline-amber-700"
              >
        ...
        <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-30" aria-label="Primary (mobile)">
            ...
            {navigationItems.map((item) => {
              ...
              return (
                <NavLink
                  ...
                  className={`flex flex-col items-center justify-center py-2 px-3 rounded-lg transition-all min-h-[56px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-indigo-600 ${
                    isActive
